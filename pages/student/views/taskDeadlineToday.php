...
*/				$dTitle = 'Today is deadline!';
				...
				<?php if ($myDoneEx > 0) { ?>
					<div class="task-progress-bar progress progress-sm progress-striped active" style="right:0">
				...
				<?php } else { ?>
					<div class="task-progress-bar" align="right" style="right:0;top:6px"><div class="label label-danger">Undo</div></div>
				<?php } ?>
				</div>
