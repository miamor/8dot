<?php if ($_GET['act'] == 'submit') include 'system/todayTaskNew.php';
else { ?>
...
<form method="POST" enctype="multipart/form-data" class="form-mi form-new-daily-exercise">
	...
	<div class="step" id="step-2" alt="Basic information" style="padding-top:5px">
		...
		<div class="c-basic-info" style="width:78%">
			...
			<div class="line line-mar daily-ex-fields" style="margin-top:15px">
				<div class="left" style="width:33%"><input type="text" name="ex-day-publish" class="datepicker required" placeholder="Day published *"/></div>
				<div class="left" style="width:33%"><input type="number" name="ex-extra-coin" class="required input-number" placeholder="Coins for solving task *"/> coin</div>
<!--				<div class="left" style="width:33%"><input type="number" name="ex-level" class="required input-number" placeholder="Difficult level *"/> %</div> -->
				<div class="left" style="padding-top:7px;width:33%"><b>Easy</b> <input type="hidden" name="ex-level" class="form-control" value="4" id="sl1"> <b>Difficult</b></div>
				<div class="clearfix"></div>
			</div>
			...
			<div class="type-display hide" id="answer">
				...
				<dl class="line">
					<dt>Result *</dt> <dd><input type="text" name="ex-result-answer" class="required"/></dd>
				</dl>
			</div>
...
<script src="<? echo PLUGINS ?>/slider/bootstrap-slider.js"></script>
<script src="<?php echo JS ?>/stepSetting.js"></script>
<script src="<?php echo JS ?>/todayTaskNew.js"></script>
