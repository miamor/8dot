...
$rCode = $eInfo = getRecord('contest', "`id` = '$iid'");
...
<div class="tsk-list">
	<div class="exam-do-info">
		<div class="main-title left" style="position:relative;width:100%;margin-bottom:-2px!important;line-height:30px">
			<?php echo '<h4 class="a-title" style="margin-bottom:-2px!important;line-height:30px;width:100%">Round '.$r.'</h4>' ?>
...
for ($j = 0; $j < count($zii); $j++) {
	...
	$tskeMyDir = MAIN_PATH.'/data/contest/_coding/'.$rInfo['code'].'/'.$tske.'/'.$au['username'].'/';
...
<div class="form-list score-board">
	<form class="borderwrap score-form task-do task-exam-do" id="taskgrading" data-action="<?php echo 'i='.$iid.'&t=result&r='.$r.'&u='.$uid ?>">
...
<script src="<?php echo JS ?>/roundResultView.program.js"></script>
