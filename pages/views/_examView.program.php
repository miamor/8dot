			...
			<div class="task-solution">
				<div class="compile-code" id="m_tab">
					<div class="compile-header m_tab">
						...
						<? if ($checkSubmit > 0 || $cInfo['uid'] == $u) echo '<div class="tab" id="sample-code">sample.'.$cInfo['language_code'].'</div>' ?>
...
<script src="<? echo PLUGINS ?>/sceditor/minified/jquery.sceditor.js"></script>
...
<? if ($checkSubmit <= 0 && $cInfo['uid'] != $u) echo '<script src="'.JS.'/examDo.js"></script>' ?>
